...
private:
  ...
  // Combined thrust-vector budget (m/s^2) -- see calcFeasibilityCost's own
  // comment for why this is a separate term from the per-axis max_acc_
  // penalty above it, not a replacement.
